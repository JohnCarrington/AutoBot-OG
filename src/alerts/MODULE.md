...
| Severity | Emoji | Use |
|---|---|---|
| INFO | ℹ️ | TRADE_OPENED, TRADE_CLOSED, STARTUP, SHUTDOWN (clean), FEED_RESUMED |
| WARNING | ⚠️ | AMEND_FAILED, BROKER_ORPHAN, MISSING_LOCAL_KEPT, MANUAL_SL_MOVE, FEED_STALE |
| CRITICAL | 🚨 | FAILURE_THRESHOLD_TRIPPED, SHUTDOWN (after crashed=True) |
